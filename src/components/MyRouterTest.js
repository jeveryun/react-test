        ...
        {context => {
          ...
          return (
            <RouterContext.Provider value={props}>
              {children ? children : props.match ? (component ? React.createElement(component) : render ? render(props) : null) : null}
            </RouterContext.Provider>
          )
        }}
      </RouterContext.Consumer>
  ...
  render() {
    ...
    return (
      <RouterContext.Consumer>
        {context => {
          return (
            <a {...rest} onClick={event => this.handleClick(event, context.history)} href={to}>
              {this.props.children}
            </a>
          )
        }}
  ...
  render() {
    return (
      <BrowserRouter>
        ...
        <Route children={props => 'xxx'}></Route>
      </BrowserRouter>
    )
  }
}
